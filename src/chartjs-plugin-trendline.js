...
const addFitter = (datasetMeta, ctx, dataset, xScale, yScale) => {
    ...
    const parsing =
        typeof datasetMeta.controller.chart.options.parsing === 'object'
            ? datasetMeta.controller.chart.options.parsing
            : undefined;
    const xAxisKey =
        dataset.trendlineLinear.xAxisKey || parsing ? parsing.xAxisKey : 'x';
    const yAxisKey =
        dataset.trendlineLinear.yAxisKey || parsing ? parsing.yAxisKey : 'y';
